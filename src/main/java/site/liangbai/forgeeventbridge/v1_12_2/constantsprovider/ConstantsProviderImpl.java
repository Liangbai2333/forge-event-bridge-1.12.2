...
package site.liangbai.forgeeventbridge.v1_12_2.constantsprovider;
...
public final class ConstantsProviderImpl implements IConstantsProvider {
    ...
    static {
        ...
        put(Constant.SUBSCRIBE_EVENT_CLASS_NAME, "Lnet/minecraftforge/fml/common/eventhandler/SubscribeEvent;");
        put(Constant.EVENT_PRIORITY_CLASS_NAME, "Lnet/minecraftforge/fml/common/eventhandler/EventPriority;");
